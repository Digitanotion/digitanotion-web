...
export default function PathBuilder() {
  ...
  function buildWhatsappLink() {
    ...
    const message = whatsapp.messageTemplate
      .replace("{courseTitle}", courseData.hero.title)
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">
              All 6 steps, one price. You save {formatMoney(savings, pricing.currencySymbol)} compared
                            ...
                            <div className="flex items-start gap-2 mb-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-amber-800 mt-1">
                                  ...
                                  Certificate as long as you complete all 6 steps eventually.
                                </p>
                              </div>
                            </div>
