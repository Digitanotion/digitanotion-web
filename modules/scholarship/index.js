      ...
      <div className="relative z-10">
        ...
        <section className="relative pt-12 pb-8 px-4 sm:px-6 lg:pt-16 lg:pb-12">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              {/* Badge - Updated to show closed */}
              <div className="inline-flex items-center gap-2 bg-red-50 backdrop-blur-sm rounded-full px-3 py-1 sm:px-4 sm:py-1.5 shadow-sm border border-red-200 mb-4 sm:mb-6">
                <HiOutlineClock className="text-red-500 text-sm" />
                <span className="text-xs sm:text-sm font-medium text-red-700">
                  Applications Closed • Scholarship Ended
                </span>
              </div>
              ...
              <motion.div
                ...
                className="max-w-2xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-gray-200 shadow-lg"
              >
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-red-100 flex items-center justify-center">
                  <HiOutlineClock className="text-red-500 text-3xl" />
                </div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">
                  Applications Are Now Closed
                </h2>
                <p className="text-gray-600 mb-4">
                  Thank you for your incredible interest in the Digitanotion
                  Academy Scholarship program.
                </p>
                <p className="text-gray-500 text-sm">
                  The scholarship deadline was April 13, 2026. All 20 seats (10
                  per track) have been filled. Selected candidates have been
        ...
        {/* Stats / Key Info Cards - Updated to show completed status */}
        ...
        {/* Tracks Selection - Keep for information */}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
                Available Tracks (Now Closed)
              </h2>
              <p className="text-gray-500 max-w-md mx-auto">
                The scholarship program offered two high-demand tracks. Learn
            ...
            <div className="grid md:grid-cols-2 gap-5 sm:gap-6">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative bg-white rounded-2xl p-5 sm:p-6 border border-gray-100 shadow-sm"
              >
        ...
        {/* Partner Callout Section - Sponsor a Student (Keep this active) */}
            ...
            >
              ...
              <div className="relative p-6 sm:p-8 md:p-12 text-center">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
                  Support Future Tech Talents
                </h2>

                <p className="text-white/90 text-base sm:text-lg max-w-2xl mx-auto mb-6">
                  While this scholarship has ended, you can still be part of
                  building Anambra's tech ecosystem. Partner with us to sponsor
                  future cohorts and help develop the next generation of tech
                  leaders.
                </p>
        ...
        {/* Partners & Footer */}
        <section className="px-4 sm:px-6 py-8 sm:py-12 border-t border-gray-100">
          <div className="max-w-5xl mx-auto text-center">
