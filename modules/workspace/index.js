...
const workspacePlans = [
  {
    ...
    features: [
      ...
      "Ergonomic chair",
      "Access to meeting rooms (2hrs/month)",
      "Free coffee & tea",
      "Power backup",
  ...
  },
  {
    ...
    features: [
      ...
      "Access to meeting rooms (10hrs/month)",
  ...
  },
  {
    ...
    priceUnit: "per hour",
    description:
      "Spacious training room with projector and whiteboard. Ideal for workshops and classes.",
    features: [
      "4K Projector & Screen",
      "Whiteboard & Markers",
      "High-speed WiFi",
